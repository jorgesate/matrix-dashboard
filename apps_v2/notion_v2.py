...
class NotionScreen:
    def __init__(self, config, modules, default_actions):
        ...
        notion_token = config.get('Notion', 'token', fallback="secret_AwxjBrs0SOKRLVW93nLUiSOpm8hBFAiM4CwIdjKAn1K")
        notion_database_id = config.get('Notion', 'database_id', fallback="ed9bdedeb6b347dfbc0365de48f104e4")
